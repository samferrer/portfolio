...
async function getAboutGithub() {
    try {
        const resposta = await fetch('https://api.github.com/users/samferrer');
        ...
        about.innerHTML = `
            ...
            <article class="about-content">
                ...
                <p>
                    Atualmente estou em transição de carreira para a área de tecnologia, cursando Análise 
                    e Desenvolvimento de Sistemas e formada no bootcamp de Desenvolvimento FullStack JavaScript pela Generation Brasil.
                </p>

                <p>
                    Gosto de aprender na prática e estou sempre buscando evoluir por meio de novos desafios e projetos.

                    Atualmente, estou em busca da minha primeira oportunidade na área de tecnologia, onde eu possa contribuir com o time, aplicar meus conhecimentos e continuar crescendo como desenvolvedora.
                </p>

                <p>
                    💻 Tecnologias: JavaScript | TypeScript | Python | HTML | CSS | React | Node.js | NestJS | MySQL | Insomnia
                </p>
...
async function getProjectsGithub() {
    try {
        ...
        const resposta = await fetch('https://api.github.com/users/samferrer/repos?sort=updated&per_page=6');
